...
p = {"Niter":     1,               # Number of DFT+DMFT iterations
     ...
     #"num_bands_win":  11,           # Number of bands to set as num_bands in .win file. If False this will be set to the number of DFT bands.
     #"exclude_bands": [1,2,3,4,5,6], # A list of bands to be excluded from Wannierization. Leave empty to ignore.
