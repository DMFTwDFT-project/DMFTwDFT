...
module comms
  ...
  !! ID of the root node
!  integer, public, save :: mpi_comm_world
...
!  public :: comms_reduce_cmplx3  ! reduce data onto all nodes
!  public :: comms_allreduce_cmplx3  ! reduce data onto all nodes
...
!    module procedure comms_reduce_int
    ...
    module procedure comms_reduce_cmplx2
    module procedure comms_reduce_cmplx3
...
!  end subroutine comms_reduce_int
  ...
  subroutine comms_reduce_cmplx2(array, size1,size2, op)
    ...
    size=size1*size2
    allocate (array_red(size1,size2), stat=ierr)
    if (ierr /= 0) then
      call io_error('failure to allocate array_red in comms_reduce_cmplx')
    end if
  ...
  end subroutine comms_reduce_cmplx2

  subroutine comms_reduce_cmplx3(array, size1,size2,size3, op)
    !! Reduce complex data to all nodes
    implicit none
  ...
  end subroutine comms_allreduce_cmplx2

  subroutine comms_allreduce_cmplx3(array, size1,size2,size3, op)
    !! Reduce complex data to all nodes
    implicit none
