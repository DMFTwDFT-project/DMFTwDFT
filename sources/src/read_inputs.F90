...
contains
  ...
  subroutine Read_wan_chk()
    ...
    do i=1,num_kpts
       ikpt(:,i)=(/ MODULO(NINT(kpt_latt(1,i)*mp_grid(1)-0.25),mp_grid(1)), &
           MODULO(NINT(kpt_latt(2,i)*mp_grid(2)-0.25),mp_grid(2)), &
           MODULO(NINT(kpt_latt(3,i)*mp_grid(3)-0.25),mp_grid(3)) /)
    enddo
